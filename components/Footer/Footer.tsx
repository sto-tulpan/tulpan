  ...
  <>
    ...
    <Wrapper>
      <Block className="about">
        <h4>СТО Тюльпан</h4>
        <p>
          Киевский Автосервис возле м. Сырец. Работа с двигателем,
          автоэлектрикой, ходовой. Установка ГБО. Ремонт и обслуживание
          выхлопных систем. Большой выбор катализаторов и гофр на все популярные
          модели. Подбор деталей на заказ.
        </p>
        <a
